...
router.post("/create", auth, createPostValidation, cloudinaryValidation, validationErrorHandler, createAPost);
router.put("/action/:action/:postId", auth, handleAction);
router.put("/edit/:postId", auth, editPostValidation, validationErrorHandler, editPost);
